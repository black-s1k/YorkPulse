    ...
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p>You must hold a valid <span className="text-gray-900 font-medium">@yorku.ca</span> or <span className="text-gray-900 font-medium">@my.yorku.ca</span> email address to register. By signing up, you confirm that you are a current member of the York University community. Accounts found to be fraudulent will be permanently banned.</p>
        </section>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-3">4. Marketplace</h2>
